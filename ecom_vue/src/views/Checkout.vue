                ...
                <div class="columns is-multiline">
                    ...
                    <div class="column is-6">
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input type="text" class="input" v-model="house_num">
                            </div>
                        </div>
                        <div class="field">
                            <label>City*</label>
...
export default {
    ...
    mounted() {
        document.title = 'Checkout | Paruyr\'s audio store'
    ...
    methods: {
        ...
        submitForm() {
            ...
            if (this.street === '') {
                this.errors.push('The street field is missing!')
            }
            if (this.house_num === '') {
                this.errors.push('The house number field is missing!')
            }
            if (this.city === '') {
